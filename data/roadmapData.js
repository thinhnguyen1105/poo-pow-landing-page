const roadmapData = [
  {
    ...
    title: ['Late Oct 2022'],
    text: "Late Oct 2022",
    actions: ['Idea, Team and Website Formation', 'Social Media Launching', 'Poo Whitelist Event', 'Poo Minting Event']
  },
  {
    id: '2',
    ...
    actions: ['Platform Development', 'Partnership Announcement', 'NFT Exchange Finalization']
  },
  {
    id: '3',
    ...
    actions: ['NFT Farming Development', 'Governance Token Contract Deployment', 'Token Contract Audit']
  },
  {
    id: '4',
